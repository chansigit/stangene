...
name: stangene
description: >
  Use when the user asks to "harmonize genes", "standardize gene names",
  "map gene identifiers", "gene name mapping", "convert Ensembl to symbol",
  "convert gene IDs", "resolve gene aliases", "fix gene names",
